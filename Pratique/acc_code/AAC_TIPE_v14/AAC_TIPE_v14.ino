 ...
 * Version 14 — Corrigée (Gestion des modes et sécurité Kick)
 * ============================================================
 *
 * ┌─ MATÉRIEL ──────────────────────────────────────────────┐
 * │  Arduino Nano Every                                      │
 ...
 */
const float K_MOTEUR        = 5.7669f;  // m/s — identifié
const float SEUIL_DEMARRAGE = 0.706f;   // normalisé — identifié
