 ...
 *  Version 6 — sélection du correcteur par #define
 * ============================================================
 *
 *  ┌─ MATÉRIEL ──────────────────────────────────────────────┐
 *  │  Arduino Nano Every                                      │
...
const float VITESSE_CIBLE_MS   = 1.40f;  // vitesse de croisière : 1,40 m/s = 5,04 km/h
...
void initSD() {
  ...
  uint8_t n = 0;
  do {
    // Nom court 8.3 compatible : PI000.CSV, PI001.CSV, etc.
